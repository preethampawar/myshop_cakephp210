...
<div class="well well-sm">
    <?php
    echo $this->Form->create('InvoiceType', array('url'=>'/invoices/add'));
    ?>
    <div class="row">
        <div class="col-xs-3">
            <?php
    ...
    <?php
        if (isset($this->data['Invoice']) && $this->data['Invoice']['invoice_type'] == 'purchase') {
            echo $this->element('invoice_purchase_form', array('invoice_type' => 'purchase', 'franchiseList' => $franchiseList, 'suppliersList' => $suppliersList, 'hasFranchise' => $hasFranchise));
        } elseif (isset($this->data['Invoice']) && $this->data['Invoice']['invoice_type'] == 'sale') {
            echo $this->element('invoice_sale_form', array('invoice_type' => 'sale', 'franchiseList' => $franchiseList, 'suppliersList' => $suppliersList, 'hasFranchise' => $hasFranchise));
        }
    ?>
</div>
<br>
