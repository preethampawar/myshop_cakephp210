                        ...
                        <td style="text-align:center;">
                            <div class="dropdown">
                                <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
                                    <li><a href="/stores/settings/<?php echo $row['Store']['id'];?>">Settings</a></li>
                                    <?php
                                    if ($this->Session->read('manager') == '1') {
                                        ?>
                                        <li role="separator" class="divider"></li>
                                        <li>
                                            <?php echo $this->Html->link('Edit Details', array('controller' => 'stores', 'action' => 'edit', $row['Store']['id']), array('title' => 'Edit ' . $row['Store']['name'])); ?>
                                        </li>
                                        <li role="separator" class="divider"></li>
                                        <li>
                                            <form
