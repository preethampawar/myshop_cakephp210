    ...
    <table class="table" style="width:100%;">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <form method="post" style="" name="invoice_remove_product_<?php echo $row['Sale']['id'];?>" id="invoice_remove_product_<?php echo $row['Sale']['id'];?>" action="<?php echo $this->Html->url("/sales/removeProduct/".$row['Sale']['id']);?>">
                        <a href="#" name="Remove" onclick="if (confirm('Are you sure you want to delete this product - <?php echo $row['Sale']['product_name'];?> from the list?')) { $('#invoice_remove_product_<?php echo $row['Sale']['id'];?>').submit(); } event.returnValue = false; return false;" class="btn btn-danger btn-xs">
            ...
            <tfoot style="font-weight:bold;">
                ...
                <tr>
                    <td style="text-align:right; color:red;" colspan='<?php echo $this->Session->read('Store.show_brands_in_products') ? 11 : 9;?>'>&nbsp;</td>
                </tr>

                <tr>
                    <td style="text-align:right;" colspan='<?php echo $this->Session->read('Store.show_brands_in_products') ? 9 : 8;?>'>
                        Total Sale Value:
                    </td>
