...
?>
	...
	<div id="AddInvoiceProductDiv" class="well">
		...
		<div class="row">
			<div class="col-xs-6 col-md-5 col-lg-4 ">
				<?php echo $this->Form->input('product_id', array('empty'=>false, 'label'=>'Select Product', 'required'=>true, 'type'=>'select', 'options'=>$productsList, 'onchange'=>'setExtraUnits(); setTotalPrice()', 'autofocus'=>true, 'class'=>'autoSuggest form-control input-sm', 'style'=>'width: 100%;'));?>
			</div>
			<div class="col-xs-2">
				<?php echo $this->Form->input('box_qty', array('type'=>'number', 'value'=>1, 'min'=>'0', 'max'=>'99999', 'label'=>'No. of Boxes', 'required'=>true, 'oninput'=>'setTotalPrice()', 'title'=>'Values should be between 1 to 99999', 'class'=>"form-control input-sm")); ?>
			</div>
			<div class="col-xs-2">
				<?php
				//debug($boxQuantity);
				...
				?>
				<?php echo $this->Form->input('extra_units', array('empty'=>false, 'label'=>'No.of Units', 'type'=>'select', 'options'=>$extraUnitArray, 'onchange'=>'setTotalPrice()', 'autofocus'=>true, 'class'=>"form-control input-sm"));?>
			</div>
			<div class="col-xs-2">				
				<button type="submit" class="btn btn-xs btn-primary" style="margin-top: 25px;" onclick = 'return submitButtonMsg()'>Add Product</button>
			</div>
		</div>
		<div class="row">
			<div class="col-xs-12">
	...
	<?php echo $this->element('invoice_products', array('invoiceProducts' => $invoiceProducts, 'invoiceInfo' => $invoiceInfo)); ?>	
