...
class ProductCategoriesController extends AppController
{
    ...
    public function index($categoryID = null)
    {
        ...
        $this->ProductCategory->bindModel(array('hasMany' => array('Product' => array('class' => 'Product', 'fields' => array('Product.id', 'Product.name', 'Product.box_qty', 'Product.box_buying_price', 'Product.unit_selling_price', 'Product.special_margin', 'Product.created', 'Product.brand_id')))));
        ...
        while (($data = fgetcsv($handle)) !== FALSE) {
            ...
            if (!empty($data)) {
                ...
                if (count($data) != 6) {
                    ...
                    $dataHeader = array('CategoryName', 'ProductName', 'BoxPrice', 'BoxQuantity', 'UnitPrice', 'SpecialMargin');
                    if ($dataHeader != $data) {
