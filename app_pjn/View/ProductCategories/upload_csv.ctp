...
<div class="notice">
	...
	<p>Before you upload CSV file, you need to have the following information.<br>Category Name, Brand Name, Product Name, Box Buying Price, Quantity in Box, Unit Selling Price</p>
	<table class='table'>
		<thead>
			<tr>
				<th>Order</th>
