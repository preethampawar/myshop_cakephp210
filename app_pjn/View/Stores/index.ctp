                        ...
                        <td style="text-align:center;">
                            <div class="dropdown dropleft">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                    <li><a href="/stores/settings/<?php echo $row['Store']['id'];?>" class="dropdown-item">Settings</a></li>
                                    <?php
                                    if ($this->Session->read('manager') == '1') {
                                        ?>
                                        <li role="separator" class="dropdown-divider"></li>
                                        <li>
                                            <?php echo $this->Html->link('Edit Details', array('controller' => 'stores', 'action' => 'edit', $row['Store']['id']), array('title' => 'Edit ' . $row['Store']['name'], 'class'=>'dropdown-item')); ?>
                                        </li>
                                        <li role="separator" class="dropdown-divider"></li>
                                        <li>
                                            <form
