        ...
        <tr>
            ...
            <td>
                ...
                if($row['type'] == 'checkbox') {
                    ...
                    <input type="checkbox" id="<?php echo $key;?>" name="<?php echo $i;?>[StoreSetting][value]" value="1" <?php echo $checked;?> >
                    <input type="hidden" name="<?php echo $i;?>[StoreSetting][name]" value="<?php echo $row['name'];?>">
                    <input type="hidden" name="<?php echo $i;?>[StoreSetting][description]" value="<?php echo $row['description'];?>">
                    <?php
                }
                ?>
