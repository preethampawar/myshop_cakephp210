	...
	<table cellspacing='1' cellpadding='1' class="table">
		...
		<tbody>
			...
			<tr>
				...
				<td>
					<?php echo $this->Html->link($this->Html->image('show_details.gif', array('class'=>'downloadImage')).'Details', array('controller'=>'quotations', 'action'=>'details', $row['Quotation']['id']), array('class'=>'btn btn-xs btn-default', 'escape'=>false));?> 
					&nbsp;&nbsp;
					<?php echo $this->Html->link('Download Quotation', array('controller'=>'quotations', 'action'=>'download', $row['Quotation']['id']), array('class'=>'btn btn-xs btn-default download', 'escape'=>false));?><span class="clear"></span>
					&nbsp;&nbsp;
					<?php echo $this->Html->link('Download Invoice', array('controller'=>'quotations', 'action'=>'download', $row['Quotation']['id'], 'invoice'), array('class'=>'btn btn-xs btn-primary download', 'escape'=>false));?><span class="clear"></span>
					&nbsp;&nbsp;
					<?php					
					echo $this->Html->link('Delete', array('controller'=>'quotations', 'action'=>'delete/'.$row['Quotation']['id']), array('class'=>'btn btn-danger btn-xs', 'escape'=>false), 'Quotation No.'.$row['Quotation']['id'].' - Are you sure you want to delete this quotation?');				
					?>
				</td>
			</tr>
			<?php
