<div class="flex p-5 noprint">
    <?php
    echo $this->Form->button('&laquo; back', array('onclick' => 'history.back()', 'escape' => false, 'class'=>'btn btn-default btn-sm'));
    ?>
                ...
                <td>
                    <div class="small mt-5">
                        <table class="table-auto w-full table table-striped table-condensed mb-0 border-t-2">
                            ...
                            <tr>
                                <td class="text-right" colspan='5'><div class="font-bold">Total (Rs.)</div></td>
                                <td class="text-right">
                                    <div class="font-bold">
