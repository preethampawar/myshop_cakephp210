...
?>
	...
	<div id="AddSaleProductDiv" class="well">
		...
		<div id="paramsDiv">			
			...
			<div style="float:left; clear:none;">
				<?php 
				echo $this->Form->input('closing_stock_qty', array('type'=>'number', 'min'=>'0', 'max'=>'99999', 'label'=>'Closing Quantity', 'required'=>true, 'oninput'=>'setTotalPrice()', 'title'=>'Values should be between 0 to 99999', 'style'=>'width:80px;'));				
				?>
	...
	<table class='table'>
		...
		<tbody>
			...
			<tr>
				...
				if($this->Session->read('Store.show_brands_in_products')) {
				?>
					<td><?php echo $row['Product']['Brand']['name'];?></td>
				<?php
				}
				?>				
