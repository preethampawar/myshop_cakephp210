					...
					<td style="width:60mm;">
						<table class="borderTable">
							<tr>
								...
								<td style="width:30mm"><b> <?php echo $quotationInfo['InvoiceQuotation']['id'];?></b></td>
							</tr>
							<tr>
								<td>Date</td>
								<td><b> <?php echo date('d - M - Y', strtotime($quotationInfo['InvoiceQuotation']['date']));?></b> </td>
							</tr>
							<tr>
								<td><?php echo ($downloadType == 'quotation') ? 'Valid till' : 'Due date'; ?></td>
								<td><b> <?php echo date('d - M - Y', strtotime($quotationInfo['InvoiceQuotation']['validity']));?></b> </td>
							</tr>							
						</table>
					</td>
				</tr>
...
<br />
<table style='width:100%'>
	<tr><td style="text-align:center; font-weight:bold;">THANK YOU FOR YOUR BUSINESS!</td></tr>
</table>