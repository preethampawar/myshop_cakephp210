                    ...
                    if(!empty($this->data['EntityItem'])) {
                        foreach($this->data['EntityItem'] as $index => $row) {
                            ...
                            <tr id="lineNo<?php echo $index;?>">
                                <td>
                                    <?php
                                    echo $this->Form->hidden('EntityItem.id.'.$index, array('value'=>$itemId));
                                    echo $this->Form->input('EntityItem.item.'.$index, array('default'=>$item, 'type'=>'text', 'label'=>false, 'div'=>false, 'lineno'=>0, 'required'=>true, 'class'=>'form-control input-sm'));
                                    ?>
                                </td>
                                <td><?php echo $this->Form->input('EntityItem.description.'.$index, array('default'=>$description, 'label'=>false, 'type'=>'text', 'div'=>false, 'lineno'=>0, 'required'=>false, 'class'=>'form-control input-sm'));?></td>
                                <td><?php echo $this->Form->input('EntityItem.quantity.'.$index, array('default'=>$quantity, 'type'=>'text', 'label'=>false, 'div'=>false, 'placeholder'=>'0', 'lineno'=>0, 'onchange'=>'calculateQuotationTotal()', 'required'=>true, 'class'=>'form-control input-sm'));?></td>
                                <td><?php echo $this->Form->input('EntityItem.unitrate.'.$index, array('default'=>$unitrate, 'type'=>'text', 'label'=>false, 'div'=>false, 'placeholder'=>'0.00', 'lineno'=>0, 'onchange'=>'calculateQuotationTotal()', 'required'=>true, 'class'=>'form-control input-sm'));?></td>
                                <td>
                                    <?php echo $this->Form->input('EntityItem.amount.'.$index, array('default'=>$amount, 'type'=>'text', 'readonly'=>true, 'label'=>false, 'class'=>'readonly lineamount', 'div'=>false, 'style'=>'width:90px; float:left;', 'placeholder'=>'0.00', 'lineno'=>0, 'class'=>'form-control input-sm'));?>

                                    <?php if($index > 0) :?>
                                    <span onclick='removeLine(<?php echo $index;?>)' title='Remove this row' lineno='<?php echo $index;?>' style='float: left; font-size:25px; cursor: pointer; margin-left: 2px;'>&times;</span>
                                    <?php endif; ?>
                                </td>
                            </tr>
                            <?php
							...
							<tbody>
								<tr>	
									...
									<td class="text-right font-weight-bold">
										<?php 
											echo $this->Form->input('subtotal', array('label'=>false, 'div'=>false, 'placeholder'=>'0.00', 'readonly'=>true, 'class'=>'readonly form-control input-sm', 'style'=>'width:100px;'));
								...
								<tr>	
									...
									<td class="text-right font-weight-bold">
										<?php echo $this->Form->input('discount', array('label'=>false, 'div'=>false, 'placeholder'=>'0.00', 'style'=>'width:100px;', 'onchange'=>'calculateQuotationTotal()', 'class'=>'form-control input-sm'));?>
									</td>
								</tr>
								<tr>	
									<td class="text-right font-weight-bold">CGST (%): </td>
									<td class="text-right font-weight-bold">
										<?php echo $this->Form->input('cgst', array('label'=>false, 'div'=>false, 'placeholder'=>'0.00', 'style'=>'width:100px;', 'onchange'=>'calculateQuotationTotal()', 'class'=>'form-control input-sm'));?>
									</td>
								</tr>
								<tr>	
									<td class="text-right font-weight-bold">SGST (%): </td>
									<td class="text-right font-weight-bold">
										<?php echo $this->Form->input('sgst', array('label'=>false, 'div'=>false, 'placeholder'=>'0.00', 'style'=>'width:100px;', 'onchange'=>'calculateQuotationTotal()', 'class'=>'form-control input-sm'));?>
									</td>
								</tr>
                                <tr>
									<td class="text-right font-weight-bold">IGST (%): </td>
									<td class="text-right font-weight-bold">
										<?php echo $this->Form->input('igst', array('label'=>false, 'div'=>false, 'placeholder'=>'0.00', 'style'=>'width:100px;', 'onchange'=>'calculateQuotationTotal()', 'class'=>'form-control input-sm'));?>
									</td>
								</tr>
								<tr>	
									...
									<td class="text-right font-weight-bold">
										<?php 
											echo $this->Form->input('total_amount', array('label'=>false, 'div'=>false, 'placeholder'=>'0.00', 'class'=>'readonly', 'style'=>'width:100px;', 'class'=>'form-control input-sm'));
											echo ' '.$this->Session->read('Company.currency');
										?>
									</td>
								</tr>
