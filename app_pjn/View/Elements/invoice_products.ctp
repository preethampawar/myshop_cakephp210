		...
		<table class="table" style="width:100%;">
			...
			<tbody>
				...
				<tr>
					...
					<td>
						<form method="post" style="" name="invoice_remove_product_<?php echo $row['Sale']['id'];?>" id="invoice_remove_product_<?php echo $row['Sale']['id'];?>" action="<?php echo $this->Html->url("/purchases/removeProduct/".$row['Sale']['id']);?>">						
