...
<head>
    ...
    <link rel="stylesheet" href="<?php echo $this->Html->url('/css/smoothness/jquery-ui-1.8.18.custom.css'); ?>">
    <?php echo $this->Html->css('smoothness/jquery-ui-1.8.18.custom'); // jQuery UI ?>
            ...
            <nav style="font-size:12px;">
                ...
                if ($this->Session->check('Store')) {
                    ...
                    if ($this->Session->check('StoreSetting.hasFranchise') && $this->Session->read('StoreSetting.hasFranchise') == 1) {
                        echo $this->Html->link('Franchise', array('controller' => 'franchises', 'action' => 'index'));
                        echo "&nbsp;&nbsp;|&nbsp;&nbsp;";
                    }
                    ?>

                    <?php echo $this->Html->link('Quotations', array('controller' => 'invoice_ quotations', 'action' => 'index')); ?>
                    &nbsp;&nbsp;|&nbsp;&nbsp;
...
<!--        <script src="-->
<?php //echo $this->Html->url('/js/vendor/modernizr-2.6.2.min.js', true);?><!--"></script>-->
<!-- jquery ui -->
<script type="text/javascript" src="<?php echo $this->Html->url('/js/jquery-ui-1.12.1/jquery-ui.min.js'); ?>"></script>
<!-- bootstrap JS-->
