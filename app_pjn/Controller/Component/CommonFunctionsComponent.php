...
class CommonFunctionsComponent extends Component
{
    ...
    /** Function to get Franchise info **/
    public function getFranchiseInfo($franchiseId = null)
    {
        ...
        if (!$franchiseId) {
            ...
            $conditions = array('Franchise.id' => $franchiseId, 'Franchise.is_deleted' => 0, 'Franchise.store_id' => $this->Session->read('Store.id'));
            if ($franchiseInfo = $this->Franchise->find('first', array('conditions' => $conditions))) {
