<div class="fixed-top" style="width:16rem; left: auto; margin-top: 8rem; margin-right: 0.5rem;">
	<div id="<?php echo h($key) ?>Message" class="toast d-flex align-items-center text-white bg-primary border-white" role="alert" aria-live="assertive" aria-atomic="true">
