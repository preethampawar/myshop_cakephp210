<div class="my-3 d-flex justify-content-between align-items-center">
	...
	<button id="addCategoryButton" type="button" class="btn btn-sm btn-info" onclick="$('#categoryForm').toggleClass('d-none'); $('#addCategoryButton').toggleClass('d-none')">+ Add New Category</button>
</div>
