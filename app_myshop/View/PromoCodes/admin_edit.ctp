...
<header><h2>Edit PromoCode</h2></header>
...
<div class="mt-3">
	...
	<input
			...
			value="<?= $this->data['PromoCode']['start_date'] ? date('Y-m-d', strtotime($this->data['PromoCode']['start_date'])) : date('Y-m-d') ?>"
			class="form-control form-control-sm"
	>
</div>
...
<div class="mt-3">
	...
	<input
			...
			value="<?= $this->data['PromoCode']['end_date'] ? date('Y-m-d', strtotime($this->data['PromoCode']['end_date'])) : date('Y-m-d') ?>"
			class="form-control form-control-sm"
	>
</div>
