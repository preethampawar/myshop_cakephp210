		...
		?>
			...
			if($this->Session->check('Store.name')) {
				...
				<li class="nav-item border-top">
					<a class="nav-link" href="/sales/addClosingStockMobile"><i class="fa fa-plus-circle"></i> Add Closing Stock</a>
				</li>
				<li class="nav-item">
					<a class="nav-link" href="/sales/viewClosingStock"><i class="fa fa-list-alt"></i> Show Closing Stock Report</a>
				</li>
				<li class="nav-item border-top">
					<a class="nav-link" href="/invoices/add"><i class="fa fa-plus-circle"></i> Add New Invoice</a>
				</li>
				<li class="nav-item">
					<a class="nav-link" href="/invoices/"><i class="fa fa-list-alt"></i> Show Invoice List</a>
				</li>
				<li class="nav-item border-top">
					<a class="nav-link" href="/reports/dayWiseStockReport"><i class="fa fa-list-alt"></i> Show Custom Stock Report</a>
				</li>
				<li class="nav-item">
					<a class="nav-link" href="/reports/completeStockReport"><i class="fa fa-list-alt"></i> Show Complete Stock Report</a>
				</li>
				<li class="nav-item">
			...
			<li class="nav-item">
				<a class="nav-link" href="#" onclick="location.reload(true);"><i class="fa fa-sync-alt"></i> Refresh App</a>
			</li>
			<li class="nav-item">
