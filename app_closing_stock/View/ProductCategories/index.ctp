...
<div class="row">
	...
	<div class="col-xs-7 col-sm-7 col-lg-9">
		<p><?php echo $this->Html->link('Import Products', ['controller' => 'product_categories', 'action' => 'uploadCsv']); ?>
			&nbsp;|&nbsp;<?php echo $this->Html->link('Download Products', ['controller' => 'product_categories', 'action' => 'downloadCsv']); ?></p>
		<br>
