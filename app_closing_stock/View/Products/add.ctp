	...
	<table class="table">
		...
		foreach ($products as $row) {
			...
			<tr>
				...
				<td><?php echo $this->Html->link('<span class="fa fa-pencil" aria-hidden="true"></span>', ['controller' => 'products', 'action' => 'edit', $productCategoryInfo['ProductCategory']['id'], $row['Product']['id']], ['title' => 'Edit Product - ' . $row['Product']['name'], 'escape' => false, 'class' => 'btn btn-warning btn-xs']); ?>
				</td>
			</tr>
			<?php
		}
