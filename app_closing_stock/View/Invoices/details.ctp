...
<div class="mb-3 mt-3">
    <a href="/invoices/edit/<?php echo $invoiceInfo['Invoice']['id']; ?>" class="btn btn-sm btn-primary small">Edit Ivoice Details</a>
    <a href="/invoices/selectInvoice/<?php echo $invoiceInfo['Invoice']['id']; ?>" class="btn btn-sm btn-primary ml-3 small">Add/Remove Products</a>
</div>
