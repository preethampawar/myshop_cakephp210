...
if ($viewType != 'download') { ?>
    ...
    <div>
        ...
        <div class="mb-3">
            <?php
            $options = array('download' => 'Download');
            echo $this->Form->input('view_type', array('empty' => 'Normal View', 'label' => 'Download/Select View', 'type' => 'select', 'options' => $options, 'escape' => false, "class" => "form-control form-control-sm"));
            ?>
        </div>

        <div class="mb-3">
            <?php echo $this->Form->input('product_id', array('empty' => 'All', 'label' => 'Select Product', 'type' => 'select', 'options' => $productsList, 'escape' => false, "class" => "form-control form-control-sm")); ?>
        </div>
