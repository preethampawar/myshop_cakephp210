	...
	<div id="AddSaleProductDiv" class="well">
		...
		<div id="paramsDiv">
			<div style="float:left; clear:none;">
				<?php echo $this->Form->input('product_id', ['empty' => false, 'label' => 'Product [available stock]', 'required' => true, 'type' => 'select', 'options' => $productsList, 'onchange' => 'setDefaultProductPrice(); setTotalPrice();', 'autofocus' => true, 'escape' => false, 'class' => 'autoSuggest']); ?>
			</div>
			<div style="float:left; clear:none;">
				<?php
