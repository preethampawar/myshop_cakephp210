    ...
    <div id="AddSaleProductDiv" class="well">
        ...
        <div class="row">
            <div class="col-xl-12">
                <div class="mb-3">
                    ...
                    <input type="date" name="data[Sale][sale_date]" id="SaleSaleDate" value="<?php echo $saleDate; ?>" class="form-control form-control-sm" required>
                    <?php
        ...
        <div class="row">
            <div class="col-xl-12">
                <div class="form-group input-group-sm mb-3">
                    <?php
                    echo $this->Form->input('closing_stock_qty', array(
                        'type'=>'number',
                        'min'=>'0',
                        'max'=>'999999',
        ...
        <div class="row">
            <div class="col-xl-12 text-center">
                <button type="submit" id='SubmitForm' title='' class="btn btn-primary btn-md form-control" onclick="return submitButtonMsg()">Add Closing Stock</button>
            </div>
        </div>
