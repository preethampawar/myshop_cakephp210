	...
	<div id="AddSaleProductDiv" class="well">
        ...
        <div class="row">
            <div class="col-xs-12" style="margin-left: 4px;">
                <?php
                echo $this->Form->hidden('date_change', array('type'=>'hidden', 'value'=>0));
                echo $this->Form->input('sale_date', array(
                    'label'=>'Sale Date',
                    'required'=>true,
                    'type'=>'date',
		...
		<div class="row">
			...
			<div style="float:left; clear:none;">
				<?php 
				echo $this->Form->input('closing_stock_qty', array('type'=>'number', 'min'=>'0', 'max'=>'99999', 'label'=>'Closing Quantity', 'required'=>true, 'oninput'=>'setTotalPrice()', 'title'=>'Values should be between 0 to 99999', 'class'=>'form-control input-sm', 'style'=>'width:80px;'));
				?>
				...
				echo $this->Form->input('reference', array('type'=>'hidden', 'value'=>'#ClosingStock'));
				?>
			</div>

			<div style="float:left; clear:none; margin-top:5px;">
				<br>
                <button type="submit" id='SubmitForm' title='' class="btn btn-primary btn-sm" onclick="return submitButtonMsg()">Add Product</button>
