...
<a href="/invoices/edit/<?php echo $invoiceInfo['Invoice']['id'];?>" class="btn btn-sm btn-primary"> &laquo; Back to Step-1</a>
<a href="/invoices/" class="btn btn-sm btn-secondary ml-3">Go to Invoice List</a>

<h1 class="mt-3">Add Invoice Products</h1>
<h4>Step-2: Invoice No. <?php echo $this->Session->read('Invoice.name');?></h4><hr>
...
?>
	...
	<div id="AddInvoiceProductDiv" class="mt-3">
		...
		<div id="paramsDiv">
            ...
            <div class="mb-3">
                <?php  echo $this->Form->input('box_qty', array(
                            'type'=>'number',
                            'value'=>1,
                            'min'=>'0',
                            'max'=>'99999',
            ...
            <div class="mb-3">
                <?php
                    echo $this->Form->input('extra_units', array(
                        'empty'=>false,
                        'label'=>'No.of Units',
                        'type'=>'select',
        ...
        <div class="mb-3">
            <button id="SubmitForm" title='' type="submit" class="btn btn-primary btn-md form-control" onclick="return submitButtonMsg()">Add Product</button>
        </div>
                    ...
                    <ul class="dropdown-menu small" aria-labelledby="dropdownMenuButton">
                        ...
                        if($this->Session->read('Store.show_brands_in_products')) {
                            if(isset($row['Product']['Brand']['name'])) {
                                ?>
                                <li>
                                    <a class="dropdown-item small disabled"><?php echo $row['Product']['Brand']['name'];?>></a>
                                </li>
