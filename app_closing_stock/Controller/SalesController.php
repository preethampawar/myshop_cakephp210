    ...
    public function removeProduct($purchaseID = null)
    {
        if ($this->request->isPost()) {
            if ($purchaseInfo = $this->CommonFunctions->getSaleInfo($purchaseID)) {
                ...
                $this->Session->setFlash('"' . $purchaseInfo['Sale']['product_name'] . '" removed from the list', 'default', array('class' => 'alert alert-success'));
            } else {
                $this->Session->setFlash('Product not found', 'default', array('class' => 'alert alert-danger'));
            }
        } else {
        ...
        if (!$dateChange and $this->request->isPost() or $this->request->isPut()) {
            ...
            if (!$error) {
                ...
                if ($this->Sale->save($data)) {
                    ...
                    $this->redirect(array('controller' => 'sales', 'action' => 'addClosingStockMobile'));
                }
            }
        }
